...
class Plugin {
	...
	private function define_core_hooks() {
		smart_product_options_addons_log( 'Plugin: Bootstrapping REST API controllers.', 'DEBUG' );
		// Initialize API controllers from config
		$api_controllers = include SMART_PRODUCT_OPTIONS_ADDONS_PATH . 'config/api.php';
	...
	public function enqueue_public_styles() {
		wp_enqueue_style( SMART_PRODUCT_OPTIONS_ADDONS_OPTION_NAME . '_public', SMART_PRODUCT_OPTIONS_ADDONS_URL . 'assets/css/public.css', array(), SMART_PRODUCT_OPTIONS_ADDONS_VERSION );
	}
	...
	private function define_admin_hooks() {
		smart_product_options_addons_log( 'Plugin: Bootstrapping Core classes.', 'DEBUG' );
		// Initialize Core classes from config
		$core_classes = include SMART_PRODUCT_OPTIONS_ADDONS_PATH . 'config/core.php';
	...
	public function change_plugin_display_name( $plugins ) {
		...
		if ( isset( $plugins[ $plugin_basename ] ) ) {
			$plugins[ $plugin_basename ]['Name'] = 'Smart Product Options and Addons';
		}
	 ...
	 */
	public function run() {
		smart_product_options_addons_log( 'Plugin: Smart Product Options and Addons is fully loaded and running.', 'INFO' );
		$this->loader->run();
	}
