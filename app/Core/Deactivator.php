...
class Deactivator {
	...
	public static function deactivate() {
		opopw_log( 'Deactivator: Firing OptionBay - Product Options and Addons deactivation steps.', 'INFO' );
		...
		opopw_log( 'Deactivator: OptionBay - Product Options and Addons deactivated successfully.', 'INFO' );
	}
